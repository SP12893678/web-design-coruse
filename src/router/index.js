...
import week13 from '../views/web-design-course/week13.vue'
import week14 from '../views/web-design-course/week14.vue'
    ...
    routes: [
        { path: '/', component: CourseMenu },
        {
            ...
            children: [
                ...
                { path: 'week13', component: week13 },
                { path: 'week14', component: week14 }
            ]
        },
